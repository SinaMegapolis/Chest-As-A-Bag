...
import net.sinamegapolis.caab.caab_code.tileentities.TileEntityChestAsABagRenderer;
...
public class ClientProxy extends CommonProxy {
    ...
    public void registerRenderers(){
        ClientRegistry.bindTileEntitySpecialRenderer(TileEntityChestAsABag.class,new TileEntityChestAsABagRenderer());
    }
}
