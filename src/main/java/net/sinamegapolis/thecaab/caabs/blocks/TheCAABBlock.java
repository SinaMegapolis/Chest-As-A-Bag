 ...
 */
public class TheCAABBlock extends Block implements IHasModel {
    ...
    public TheCAABBlock(String name) {
        super(Material.WOOD);
    ...
    @Nullable
    @Override
    public TheCAABTE createTileEntity(World world, IBlockState state){
         return new TheCAABTE();
    }

    public Class<TheCAABTE> getTheCAABTEsclass(){
        return TheCAABTE.class;
    }
    ...
    public TheCAABTE getTileEntity(World world,BlockPos pos){return (TheCAABTE)world.getTileEntity(pos);}
